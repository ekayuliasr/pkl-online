...
function deleteInstitution(id) {
    ...
    if (confirm('Ingin mengapus institusi')) {
        $.ajax({
            type: "GET",
            dataType: "JSON",
            url: _baseUrl + "/master/delete/institution/" + id,
            success: function (response) {
                if (response.status) {
                    window.location.reload()
                } else {
...
function deleteUserInstitution(id) {
    
    if (confirm('Ingin menghapus user')) {
        $.ajax({
            type: "GET",
            dataType: "JSON",
            url: _baseUrl + "/master/delete/user/" + id,
            success: function (response) {
                if (response.status) {
                    window.location.reload()
                } else {
...
function deleteCompany(id) {
    ...
    if (confirm('Ingin mengapus company')) {
        $.ajax({
            type: "GET",
            dataType: "JSON",
            url: _baseUrl + "/master/delete/company/" + id,
            success: function (response) {
                if (response.status) {
                    window.location.reload()
                } else {
...
$("#add-product").submit(function(e) {
    ...
    const newLocal = $("#add-product").serialize();
    let data = newLocal
...
function deleteCategory(id) {
    ...
    if (confirm('Ingin menghapus category')) {
        $.ajax({
            type: "GET",
            dataType: "JSON",
...
function deleteJob(id) {
    ...
    if (confirm('Ingin menghapus pekerjaan?')) {
        $.ajax({
            type: "GET",
            dataType: "JSON",
