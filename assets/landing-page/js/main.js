...
$(function() {
    $.ajax({
        type: "GET",
        dataType: "JSON",
        url: "http://pklonline.net/dashboard/api/jobs",
        crossDomain: true,
                    ...
                    list += `<div class="col-lg-6">
                                <div class="blog-wrap shadow mb-70 xs-mb-50">
                                    <div class="image-part">
                                        <a href=""><img src="https://pklonline.net/dashboard/upload/jobs/`+ data.JOB_POSTER +`" alt=""></a>
                                    </div>
                                    <div class="content-part">
                                        <h3 class="title mb-10"><a href="">`+ data.JOB_POSITION +`</a></h3>
                                        <ul class="blog-meta mb-22">
                                            <li><i class="fa fa-calendar-check-o"></i> `+ data.JOB_END +`</li>
                                            <li><i class="fa fa-home"></i> `+ data.JOB_COMPANY+`</li>
                                        </ul>
                                        <p class="desc mb-20">`+ data.JOB_DESCRIPTION +`</p>
                                        <div class="btn-part">
                                            <a class="readon-arrow" href="">Apply</a>
                                        </div>
                                    </div>
                                </div>
                            </div>`;
